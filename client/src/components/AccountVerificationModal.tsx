...
const AccountVerificationModal = ({ 
  ...
  // Return null if not open to avoid rendering issues
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-[2px] z-50 flex items-center justify-center p-4">
      ...
      />
      <div
        className="bg-[#05012B] border border-[#00ECBE]/30 rounded-xl sm:max-w-[500px] w-full z-[101] overflow-hidden animate-in fade-in-0 zoom-in-95 duration-300"
