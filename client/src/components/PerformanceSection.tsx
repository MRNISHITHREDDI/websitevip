  ...
  return (
    ...
    >
      <div className="flex flex-col items-center">
        <div className="mb-4">
          <div
            className="text-6xl font-bold text-[#00ECBE]"
            style={{ textShadow: "0 0 10px rgba(0, 236, 190, 0.5)" }}
          >
            {displayScore === 10
              ? "10.0"
              : displayScore.toString().includes(".")
                ? displayScore.toFixed(1)
                : displayScore + ".0"}
          </div>
        </div>
        <div className="w-16 h-1 bg-[#00ECBE] mb-4 rounded-full"></div>
        <h3 className="text-[#00ECBE] font-poppins font-medium text-lg mb-2">
          {title}
        </h3>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-300 max-w-2xl mx-auto">
            See why thousands of users trust our platform for accurate
            predictions and exceptional experience.
          </p>
        </motion.div>
