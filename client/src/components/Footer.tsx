        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <p className="text-gray-400 mb-6">
              The most advanced color prediction platform powered by blockchain
              technology.
            </p>
          ...
          <div>
            <h3 className="text-[#00ECBE] font-poppins font-medium text-lg mb-6">
              Quick Links
            </h3>
            <ul className="space-y-3">
              <li>
                <Link
                  href="/"
                  className="text-gray-400 hover:text-[#00ECBE] transition duration-300"
                >
                  Home
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a
                  href="https://t.me/Teacher_Jalwa2"
                  target="_blank"
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm mb-4 md:mb-0">
              © {currentYear} Jalwa Games. All rights reserved.
            </p>
            <div className="flex gap-4">
