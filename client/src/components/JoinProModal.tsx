          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <p className="text-gray-100">
                <span className="font-bold">100% accurate predictions</span> for accounts created through our server
              </p>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <p className="text-gray-100">
                <span className="font-bold">Only 20% accuracy</span> for accounts not created through our server
              </p>
            </div>
          </div>
          
          <p className="text-center text-gray-300 pt-2">
            Create a new account now to access VIP predictions. It's completely free!
          </p>
        </div>
        
        <DialogFooter className="flex flex-col sm:flex-row gap-3">
          <motion.a 
            href="https://t.me/JALWA_1MINUTE_PREDICTION" 
            target="_blank"
